...
- [ ] Arm the 30-minute audit tick. In a long-running terminal session, arm a recurring wake. Otherwise rearm the same wake on each turn. Never leave the cadence to memory.
...
- [ ] Triage every review-automation and security-reviewer comment per `../references/review-triage.md`.
